package org.rs2server.rs2.model.npc.impl.abyssSyre.styles;
...
public class AbyssalSireMeleeAttackStyle<T extends AbyssalSire> extends NpcCombatState<T> {

	public static final Animation ATTACK_ANIMATION = Animation.create(5366);

	private static final int MAX_HIT = 20;

	public AbyssalSireMeleeAttackStyle(T npc) {
		super(npc);
	}
	...
	public void perform() {
		...
		World.getWorld().submit(new StoppingTick(1) {
			...
			public void executeAndStop() {
				int damage = Misc.random(MeleeCombatAction.getAction().damage(MAX_HIT, npc, challenger,
						CombatState.AttackType.SLASH, Skills.ATTACK, Prayers.PROTECT_FROM_MELEE, false, false));
