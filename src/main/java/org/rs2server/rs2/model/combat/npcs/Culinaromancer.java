...
public class Culinaromancer extends AbstractCombatAction {

	/**
	 * The singleton instance.
	 */
	private static final Culinaromancer INSTANCE = new Culinaromancer();
	...
	public void hit(final Mob attacker, final Mob victim) {
		...
		case MAGIC:
			...
			int randomHit = damage(8, attacker, victim, AttackType.MAGIC, Skills.MAGIC, Prayers.PROTECT_FROM_MAGIC,
					false, false);
			if (randomHit > 0) {
