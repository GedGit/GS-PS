...
/**
 * Red Dragon combat instance
 * 
 * @author Vichy
 *
 */
public class RedDragon extends AbstractCombatAction {

	/**
	 * The singleton instance.
	 */
	private static final RedDragon INSTANCE = new RedDragon();
	...
	public int getDamage(Mob attacker, Mob victim, CombatStyle style, int maxHit) {
		if (style == CombatStyle.MAGIC) {
			int finalRandom = damage(maxHit, attacker, victim, AttackType.MAGIC, Skills.MAGIC,
					Prayers.PROTECT_FROM_MAGIC, false, true);
			...
			return Misc.random(damage(maxHit, attacker, victim, AttackType.CRUSH, Skills.ATTACK,
					Prayers.PROTECT_FROM_MELEE, false, false));
	}
