...
public class Packet {
	 ...
	 */
	public byte get() {//where tf are they getting printed @ o.o
		return payload.get();
	}
	 ...
	 */
	public int getBEInt() {
		return ((payload.getUnsigned() << 16)
				| (payload.getUnsigned() << 24)
				| payload.getUnsigned())
				| (payload.getUnsigned() << 8);
	}
	 ...
	 */
	public short getShortA() {// whats what one
	...
	/**
	 * Reads a series of bytes in revers.
